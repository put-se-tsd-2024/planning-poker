...
namespace PlanningPoker.Server.Migrations
{
    ...
    [Migration("20240607200121_InitialCreate2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlanningPoker.Shared.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PlanningPoker.Shared.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PlanningPoker.Shared.Work", b =>
                {
                    b.HasOne("PlanningPoker.Shared.UserStory", null)
                        .WithMany("Works")
